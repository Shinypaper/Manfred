	<section class="portfolio section" id="Where">
		<h3>Here's some of our work</h3>
				<div class="clients">
					...
					<div class="client wow flipInX" data-wow-duration="1s" data-wow-delay="0.9s" href="#clientFour"><img src="assets/img/clients/seaton-logo.png" alt=""><div class="overlay"><i class="fa fa-wrench"></i>Coming Soon...</div></div>
				</div>
	</section>