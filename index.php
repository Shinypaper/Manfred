...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    ...
    <section class="where section">
        ...
        <div class="portfolio">
            <div class="container">
                <div class="clients">
                    <a class="client wow flipInY" data-wow-duration="1s" data-wow-delay="0.3s" href="/portfolio.html">
                        <figure>
                            <img src="http://placehold.it/400/202024/202024" alt="">
                            <figcaption class="client_meta">
                                Client
                            </figcaption>
                        </figure>
                    </a>
                    <a class="client wow flipInY" data-wow-duration="1s" data-wow-delay="0.5s" href="/portfolio.html">
                        <figure>
                            <img src="http://placehold.it/400/202024/202024" alt="">
                            <figcaption class="client_meta">
                                Client
                    ...
                    <a class="client wow flipInY" data-wow-duration="1s" data-wow-delay="0.7s" href="/portfolio.html">
                        <figure>
                            <img src="http://placehold.it/400/202024/202024" alt="">
                            <figcaption class="client_meta">
                                Client
                    ...
                    <a class="client wow flipInY" data-wow-duration="1s" data-wow-delay="0.9s" href="/portfolio.html">
                        <figure>
                            <img src="http://placehold.it/400/202024/202024" alt="">
                            <figcaption class="client_meta">
                                Client
